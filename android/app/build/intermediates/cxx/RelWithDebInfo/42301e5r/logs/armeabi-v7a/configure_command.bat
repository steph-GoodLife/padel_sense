...
"C:\\Users\\Utilisateur\\AppData\\Local\\Android\\sdk\\cmake\\3.22.1\\bin\\cmake.exe" ^
  ...
  "-DCMAKE_LIBRARY_OUTPUT_DIRECTORY=E:\\padel_sense\\android\\app\\build\\intermediates\\cxx\\RelWithDebInfo\\42301e5r\\obj\\armeabi-v7a" ^
  "-DCMAKE_RUNTIME_OUTPUT_DIRECTORY=E:\\padel_sense\\android\\app\\build\\intermediates\\cxx\\RelWithDebInfo\\42301e5r\\obj\\armeabi-v7a" ^
  "-DCMAKE_BUILD_TYPE=RelWithDebInfo" ^
  "-BE:\\padel_sense\\android\\app\\.cxx\\RelWithDebInfo\\42301e5r\\armeabi-v7a" ^
  -GNinja ^
  -Wno-dev ^
  --no-warn-unused-cli
