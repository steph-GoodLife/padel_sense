...
"C:\\Users\\Utilisateur\\AppData\\Local\\Android\\sdk\\cmake\\3.22.1\\bin\\cmake.exe" ^
  ...
  "-DCMAKE_LIBRARY_OUTPUT_DIRECTORY=E:\\padel_sense\\android\\app\\build\\intermediates\\cxx\\Debug\\5j2p4a1z\\obj\\armeabi-v7a" ^
  "-DCMAKE_RUNTIME_OUTPUT_DIRECTORY=E:\\padel_sense\\android\\app\\build\\intermediates\\cxx\\Debug\\5j2p4a1z\\obj\\armeabi-v7a" ^
  "-DCMAKE_BUILD_TYPE=Debug" ^
  "-BE:\\padel_sense\\android\\app\\.cxx\\Debug\\5j2p4a1z\\armeabi-v7a" ^
  -GNinja ^
  -Wno-dev ^
  --no-warn-unused-cli
